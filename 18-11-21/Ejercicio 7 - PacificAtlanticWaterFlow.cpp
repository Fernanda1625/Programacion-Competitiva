/*
Ejercicio 7: Hay una isla rectangular de m x n que limita con el Océano Pacífico y el Océano Atlántico.
El Océano Pacífico toca los bordes izquierdo y superior de la isla, y el Océano Atlántico toca los bordes
derecho e inferior de la isla. La isla está dividida en una cuadrícula de celdas cuadradas. Se le da una
...
de la celda actual. El agua puede fluir desde cualquier celda adyacente a un océano hacia el océano. Devuelve una
lista 2D de resultados de coordenadas de cuadrícula donde resultado [i] = [ri, ci] denota que el agua de lluvia
puede fluir desde la celda (ri, ci) hacia los océanos Pacífico y Atlántico. (https://leetcode.com/problems/pacific-atlantic-water-flow/)
