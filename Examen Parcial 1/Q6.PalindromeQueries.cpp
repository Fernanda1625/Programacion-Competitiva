// Pregunta 6: Procesar m operaciones de los siguientes tipos: 
// 1. Cambiar el carácter en la posición k a x 
// 2. Compruebe si la subcadena de la posición a a la posición b es un palíndromo
...
const int N = 2e5 + 5;
const long long MOD = 1e9 + 2277, BASE = 31;
