// Ejercicio 1: Para cada consulta, genere un binario si un usuario binario puede comenzar desde la ubicación
// r1, c1 y moverse a la ubicación r2, c2. Salida decimal si un usuario decimal puede moverse entre las dos
// ubicaciones. De lo contrario, no envíe ninguno. (https://open.kattis.com/problems/10kindsofpeople)
